...
* [EJERCICIO 1](2_13_metodos_funcionales_array.md#ejercicio-1)
* [EJERCICIO 2](2_13_metodos_funcionales_array.md#ejercicio-2)
* [EJERCICIO 3](2_13_metodos_funcionales_array.md#ejercicio-3)
* [EJERCICIO 4](2_13_metodos_funcionales_array.md#ejercicio-4)
* [EJERCICIO 5](2_13_metodos_funcionales_array.md#ejercicio-5)
* [EJERCICIO 6](2_13_metodos_funcionales_array.md#ejercicio-6)
* [EJERCICIO 7](2_13_metodos_funcionales_array.md#ejercicio-7)
* [EJERCICIO 8](2_13_metodos_funcionales_array.md#ejercicio-8)
* [EJERCICIO 9](2_13_metodos_funcionales_array.md#ejercicio-9)
* [EJERCICIO 10](2_13_metodos_funcionales_array.md#ejercicio-10)
* [EJERCICIO 11](2_13_metodos_funcionales_array.md#ejercicio-11)
* [EJERCICIO 12](2_13_metodos_funcionales_array.md#ejercicio-12)

## Introducción

En esta sesión vamos a ver cómo trabajar con arrays de forma eficiente en JavaScript. Hasta ahora hemos trabajado con arrays y conocemos algunos métodos del objeto array, como `push` para meter nuevos elementos en el array o `join` para unir todos los elementos de un array en una cadena. Y cuando queremos acceder todos los elementos de un array, usamos un bucle para recorrerlo. Pero en esta sesión vamos a aprender a realizar acciones con varios elementos de un array pero sin necesidad de bucles, usando los denominados _métodos funcionales_ de array. Se llaman métodos funcionales porque están alineados con una forma de programar que da mucha importancia a las funciones... ¡nuestras amigas las funciones!
