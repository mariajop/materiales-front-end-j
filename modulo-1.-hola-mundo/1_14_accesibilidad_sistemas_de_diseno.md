# 1.14 Accesibilidad y Sistemas de diseño

## Contenidos

* [EJERCICIO 1](1_14_accesibilidad_sistemas_de_diseno.md#ejercicio-1)
* [EJERCICIO 2](1_14_accesibilidad_sistemas_de_diseno.md#ejercicio-2)
* [EJERCICIO 3](1_14_accesibilidad_sistemas_de_diseno.md#ejercicio-3)
* [EJERCICIO 4](1_14_accesibilidad_sistemas_de_diseno.md#ejercicio-4)
* [EJERCICIO BONUS 5](1_14_accesibilidad_sistemas_de_diseno.md#ejercicio-bonus-5)
* [EJERCICIO BONUS 6](1_14_accesibilidad_sistemas_de_diseno.md#ejercicio-bonus-6)
...
Puedes leer más sobre qué es un crawler aquí: [https://es.ryte.com/wiki/Crawler](https://es.ryte.com/wiki/Crawler)
...
1. **Los landmarks.** Se usan para identificar áreas de tu página y transmitir la naturaleza de la mismas. Así añadimos características útiles de navegación que transmiten información sobre la estructura de la página. Simplemente tenemos que añadir al elemento contenedor \(el “div” por ejemplo\) el código role=”\[tipo\_landmark\]”. Por ejemplo, `<div role=”main”>` para marcar el "div" que contiene la zona de contenido principal. ¿Verdad que es sencillo? Hay varios tipos de landmarks dependiendo de la etiqueta HTML a la que acompañen los más importantes son los que os indicamos aquí abajo:
...
![Paleta de colores del sistema Carbon de IBM](../.gitbook/assets/paleta-de-colores-carbon.png)
...
![Bot&#xF3;n de Carbon](../.gitbook/assets/button.png) ![Link de Carbon](../.gitbook/assets/link.png)
...
Para finalizar, vamos a cambiar los colores que tenemos por los de esta página: [http://flatuicolors.com/](http://flatuicolors.com/). Sustituiremos el turquesa que tenemos actualmente en la web por el turquesa de FlatUIColors y el negro por el Wet Asphalt.
...
![Estilos de botones](../.gitbook/assets/button-styles.png)
...
[▸ Ejemplo en CodePen](https://codepen.io/adalab/pen/vQEjGL)
...
[▸ Ejemplo en CodePen](https://codepen.io/adalab/pen/QJwrGQ)
...
[▸ Ejemplo en CodePen](https://codepen.io/adalab/pen/zMxjdQ)
...
![Bot&#xF3;n de Carbon](../.gitbook/assets/ui.png)
