# 1.7 Publicando nuestra web

## Contenidos

* [EJERCICIO 1](1_7_publicando_nuestra_web.md#ejercicio-1)
* [EJERCICIO 2](1_7_publicando_nuestra_web.md#ejercicio-2)
* [EJERCICIO 3](1_7_publicando_nuestra_web.md#ejercicio-3)
* [EJERCICIO 4](1_7_publicando_nuestra_web.md#ejercicio-4)
* [EJERCICIO 5](1_7_publicando_nuestra_web.md#ejercicio-5)
* [EJERCICIO 6](1_7_publicando_nuestra_web.md#ejercicio-6)
* [EJERCICIO 7](1_7_publicando_nuestra_web.md#ejercicio-7)
* [EJERCICIO 8](1_7_publicando_nuestra_web.md#ejercicio-8)
* [EJERCICIO 9](1_7_publicando_nuestra_web.md#ejercicio-9)
* [EJERCICIO 10](1_7_publicando_nuestra_web.md#ejercicio-10)
* [EJERCICIO 11](1_7_publicando_nuestra_web.md#ejercicio-11)
* [EJERCICIO 12](1_7_publicando_nuestra_web.md#ejercicio-12)
* [EJERCICIO 13](1_7_publicando_nuestra_web.md#ejercicio-13)
...
![Terminal de ubuntu](../.gitbook/assets/terminal-ubuntu.png)
...
Las rutas pueden ser _absolutas_, como la que nos devuelve el comando `pwd`, y empiezan por `/`. También pueden ser _relativas_, que usaremos más adelante. Las relativas usan los caracteres especiales `..` para referirse a la carpeta madre de nuestra carpeta actual, o `.` \(o nada\) para referirnos a una carpeta que está dentro de nuestra carpeta actual.
...
Si queremos copiar o mover archivos usaremos los comandos `cp` o `mv`. El formato será `cp`/`mv` archivo-de-origen archivo\_de\_destino.
...
Desde la terminal, vamos a crear un nuevo proyecto en nuestra carpeta de proyectos que se llame `rutas-relativas`, con las carpetas `images` y `styles`. Y los archivos `index.html` \(en la raíz del proyecto\), `style.css` \(en la carpeta `styles`\) y `imagen-de-prueba.jpg` \(en la carpeta `images`, la podéis descargar desde [este enlace](https://github.com/Adalab/materiales-front-end-j/tree/f76fa3db835413e155a9d7df00e2e7fb71041a29/sprint_1/assets/images/1-7/imagen-de-prueba.jpg)\).
...
¿Cómo es la ruta de ambas imágenes? ¿Absoluta? ¿Relativa? ¿Es diferente en los dos casos? ¿Por qué?
...
2. `git commit -m "Mensaje"` nos permite crear como un paquete de cambios y "guardarlo en nuestro sistema de versiones", nos dejará escribir un mensaje corto para asociarlo al paquete de cambios o _commit_.
...
![Nuevo repositorio](../.gitbook/assets/github-repo-1.png)
...
![Nuevo repositorio](../.gitbook/assets/github-repo-2.png)
...
![Nuevo repositorio](../.gitbook/assets/github-repo-3.png)

Ahora, con esta url podemos irnos a nuestra terminal y clonarlo con `git clone`:

![Nuevo repositorio](../.gitbook/assets/github-repo-4.png)
...
> **Nota**: Por defecto git nos creará una carpeta con un nombre automático, si queremos un nombre específico para la carpeta de nuestro proyecto podemos declararlo tras la url que nos da GitHub:

```text
git clone url-del-repositorio-que-me-da-github nuevo-nombre-de-carpeta
```

Ahora tenemos un repositorio local en la carpeta en la que hemos clonado nuestro nuevo repositorio remoto. Si accedemos a la carpeta, dentro debería estar el archivo README.md.
...
![Nuevo repositorio](../.gitbook/assets/github-repo-5.png)

1. Copiamos la línea con `git remote add origin url-del-repositorio-que-me-da-github`
2. Desde la terminal, nos vamos a la carpeta de nuestro proyecto que ya tiene inicializado un repo local y ejecutamos la línea que hemos copiado. Esto conectará los dos repos.
...
2. Añadimos el repositorio que acabamos de crear como repositorio remoto en nuestro proyecto usando `git remote` como se muestra en el video.
3. Hacer _push_ para mandar la info del proyecto al repositorio remoto y, de esta forma, almacenar los datos del proyecto en GitHub. Comprobar tras hacerlo que, al abrir la página del proyecto en GitHub, se muestran los cambios que hemos realizado en nuestro ordenador.
4. Realizar un cambio en el CSS del proyecto para que el texto de la cara sonriente se muestre centrado vertical y horizontalmente en la página.
5. Una vez que estemos conforme con nuestro tipo sonriente, haremos un commit para añadir el cambio a nuestro repositorio y otro push, para sincronizar los cambios de nuestro repositorio local con los del remoto y, de esta forma, subir los cambios a GitHub.
...
2. Clonar el proyecto en ambos ordenadores \(el tuyo y el de tu compañera\) con `$ git clone url-del-repositorio-que-me-da-github` \(como se explica en ejercicio 6\).
3. Una de las compañeras debe añadir el fichero `index.html` en la raíz del proyecto.
4. La compañera que haya hecho el cambio anterior debe hacer un commit y luego un push para subir el cambio a GitHub.
5. Después, el resto de compañeras debe hacer `git pull` \(desde dentro de la carpeta del proyecto\) para descargarse los cambios a su ordenador.
6. Abrir el proyecto con VSCode para comprobar que, efectivamente, los cambios se han descargado desde GitHub.
7. Ahora otra compañera puede hacer otro cambio en `index.html`, hacer otro commit y otro push.
8. Repetir los pasos del 4 al 7 tantas veces como se quiera.
