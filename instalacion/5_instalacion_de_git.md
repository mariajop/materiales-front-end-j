...
- [Cómo clonar un repositorio de Git](assets/videos/git-clonar-un-repositorio.mp4) [1](http://beta.adalab.es/materiales-front-end-j/instalacion/assets/videos/git-clonar-un-repositorio.mp4)
