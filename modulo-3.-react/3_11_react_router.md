...
En esta sesión veremos cómo usar React para escribir aplicaciones web de una sola página \(_Single Page Applications_, en inglés\) usando un complemento llamado [React Router](https://reacttraining.com/react-router/).
...
[▸ Rutas con React Router en Codepen](https://codepen.io/adalab/pen/MrZQpE?editors=0010)
...
Por otro lado, los enlaces de la cabecera enlazan a `/child/1`, `/child/2`, etc. Al hacer clic en alguno de estos enlaces, se renderizará el componente `Child` al que le llegará por `props` un parámetro `match` que tiene información sobre los parámetros de la URL, en este caso, el número al final de la URL \(`:id`\). **App.js**:
...
[▸ Rutas con React Router en Codepen](https://codepen.io/adalab/pen/eKwbMZ?editors=0010)
...
Vamos a partir del ejercicio de la sesión anterior sobre un directorio de personas. En la página principal aparecía un listado de personas con información de [https://randomuser.me/](https://randomuser.me/).
...
[▸ Menú consciente de la ruta actual en Codepen](https://codepen.io/adalab/pen/OzrYZN?editors=0010)
